...
class WP_Sticky_CTA_Data {
    ...
    // Declare all standard properties
    public $id = 0;
    public $SSuprydp_impressions = "0";
    public $SSuprydp_clicks = "0";
    public $SSuprydp_development = "development";
    public $SSuprydp_shrink = "No";
    public $SSuprydp_shrink_tablet = "No";
    public $SSuprydp_shrink_mobile = "No";
    public $SSuprydp_dis_desktop = "Yes";
    public $SSuprydp_dis_tablet = "Yes";
    public $SSuprydp_dis_mobile = "Yes";
    public $SSuprydp_location = "home";
    public $SSuprydp_location_type = "Pages";
    public $SSuprydp_img_hideimg = "No";
    public $SSuprydp_hideimg_tablet = "No";
    public $SSuprydp_hideimg_mobile = "No";
    public $sticky_s_media = "";
    public $image_attachment_id = "0";
    public $SSuprydp_button_option_text = "Click Here";
    public $SSuprydp_button_option_backg_color = "#4e0d61";
    public $SSuprydp_button_option_font = "Open Sans";
    public $SSuprydp_button_option_weight = "400";
    public $SSuprydp_button_option_size = "20";
    public $SSuprydp_button_option_align = "left";
    public $SSuprydp_button_option_color = "#fff";
    public $SSuprydp_content_option_text = "This is the Content Area. Put a description here of what you want to promote.";
    public $SSuprydp_content_option_font = "Open Sans";
    public $SSuprydp_content_option_weight = "800";
    public $SSuprydp_content_option_size = "25";
    public $SSuprydp_content_option_color = "#fff";
    public $SSuprydp_divider_option_color = "#1b7ccc";
    public $SSuprydp_action_option_text = "Click Here to View";
    public $SSuprydp_action_option_font = "Open Sans";
    public $SSuprydp_action_option_weight = "500";
    public $SSuprydp_action_option_size = "19";
    public $SSuprydp_action_option_color = "#fff";
    public $SSuprydp_action_option_url = "https://wpctapro.com/";
    public $SSuprydp_target_blank = "No";
    public $SSuprydp_nofollow = "No";
    public $SSuprydp_cta_position = "center";
    public $sidebar_template = "sticky-cta";
    public $line_separator_show = "yes";
    public $line_separator_color = "#fff";
    public $collapse_on_page_load = "no";
    public $locations = array();
    public $exclude_locations = array();
    
    // For any dynamic properties that might come from the database
    private $dynamic_properties = array();

    function __construct($sticky_data = array()) {
        ...
        foreach ($this->sticky_data as $key => $value) {
            if (property_exists($this, $key)) {
                ...
                // Store dynamic properties separately
    ...
    public function __get($key) {
        if (property_exists($this, $key)) {
            return $this->$key;
        } elseif (isset($this->dynamic_properties[$key])) {
    ...
    private function get_options() {
        ...
        $options = $wpdb->get_results($wpdb->prepare(
            "SELECT * FROM {$wpdb->prefix}sticky_cta_options WHERE sticky_cta_id = %d", 
            $this->sticky_data->id
        ));
        ...
        foreach ($options as $option) {
            ...
            if (property_exists($this, $option_name)) {
                ...
                $this->dynamic_properties[$option_name] = $option_value;
                $this->sticky_data->$option_name = $option_value;
            }
        }
    }
    ...
    public function get_locations() {
        ...
        $locations = isset($this->dynamic_properties['locations']) ? 
                    $this->dynamic_properties['locations'] : 
                    (isset($this->locations) ? $this->locations : array());
    ...
    public function get_exclude_locations() {
        ...
        $exclude_locations = isset($this->dynamic_properties['exclude_locations']) ? 
                           $this->dynamic_properties['exclude_locations'] : 
                           (isset($this->exclude_locations) ? $this->exclude_locations : array());
    ...
    public function to_array() {
        ...
        unset($properties['dynamic_properties']);
        return array_merge($properties, $this->dynamic_properties);
    }
}